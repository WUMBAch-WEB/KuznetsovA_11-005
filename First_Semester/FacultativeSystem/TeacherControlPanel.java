...
public class TeacherControlPanel {
    ...
    public void teacherChoice(){
        ...
        System.out.println("[1]Добавить курс            [2]Удалить Курс      [3]Информация о моих курсах");
        System.out.println("[x]Изменить личные данные   [x]Проверить почту   [x]Написать письмо");
